...
\definecolor{bpvacuous}{HTML}{7A0019}
\newcommand{\stVacuous}{\textcolor{bpvacuous}{\textbf{[VACUOUS]}}}       % proved, but from hypotheses that cannot all hold
\newcommand{\stRefuted}{\textcolor{bpvacuous}{\textbf{[REFUTED]}}}       % a hypothesis or clause shown unsatisfiable / false
\newcommand{\stFixed}{\textcolor{bpchecked}{\textbf{[FIXED]}}}           % fixed after the snapshot, on the branch named
\newcommand{\stLanded}{\textcolor{bpproved}{\textbf{[LANDED]}}}          % landed on dev/verify after the snapshot
\newcommand{\stPlanned}{\textcolor{bpoutside}{\textbf{[PLANNED]}}}       % specified, not yet done
