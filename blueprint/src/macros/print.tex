...
% \detokenize lets underscores and primes through; names break at the spaces after commas.
\newcommand{\lean}[1]{{\par\noindent\footnotesize\textcolor{bpoutside}{\textsf{Lean:}
  \ttfamily\detokenize{#1}}\par\smallskip}}
