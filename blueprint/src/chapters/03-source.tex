...
still passes \code{peregrine validate} --- and a separate constructor exists purely to
prevent \emph{vacuous} coverage, since a recursor spine has no source evaluation at all.
