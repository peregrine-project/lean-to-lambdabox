...
\code{lit} & $\code{lit}\ l$ & $t$ & $l$'s one-step kernel unfolding erases to $t$ \\
...
dependency-closure premise. Two premises are supplied separately --- the all-scopes form of
...
the four remaining fields plus two premises.
\begin{proof}
\leanok
...
own block and eliminator, block and eliminator uniqueness, and three kername-separation
...
through \code{app} (design tag F-ETA). There is no case rule and no fixpoint rule, because
